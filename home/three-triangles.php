...
<body>
    <div class="text-wrapper">
        ...
        <ol>
            <li>
                <p><code>baseSize</code> (Default: 100) &mdash; This can be an integer or an array of integers. It control the background's block size.</p>
            </li>
            <li>
                <p><code>triangleSize</code> (Default: [20, 20]) &mdash; This has to be an array that specifies the size of triangles.</p>
            </li>
            ...
            <div class="n-card">
                ...
                <div class="n-card-body">
                    ...
                    <div class="n-flex n-flex-eq-sw n-gap-x4">
                        <div class="wrapper">
                            <div class="code">
                                <pre><code class="lang-js">let gradientObject =  new NeatgradientObjectTriangles({
    element: boxElems[0],
        ...
        let gradientSettings = [{},
            {
                baseSize: 80,
                angle: [45, 135],
                bgPosMultipliers: [0, 0, -0.5, 0]
            },
            {
                baseSize: 150,
                angle: [315, 45],
                variant: 'band-shades',
                bands: [15, 20, 35, 40, 48],
                bgPosMultipliers: [0, 0, 0, 0.5]
            },
            {
                seamless: true,
                parts: 16,
                bands: [30, 30, 30, 40, 50]
            },
            {
                baseSize: 140,
                angle: [-60, 30],
                bgPosMultipliers: [0, -0.5, 0, 0.5],
                variant: 'half-shades'
            },
            {
                baseSize: 90,
                updateVariable: true,
                variant: 'half-shades',
                bgPosMultipliers: [0.5, 1.5, 0.5, -1.5]
            },
            {
                seamless: true,
                parts: 8,
                ...
                updateVariable: true,
                variant: 'band-shades',
                bgPosMultipliers: [0, 0, -0.75, -0.25]
            },
            {
                baseSize: 80,
                angle: [45, 225]
            ...
            },
            {
                seamless: true,
                parts: 8,
                bgPosMultipliers: [0, 0, -0.75, 0.75]
            }
        ];
